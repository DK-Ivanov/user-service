...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, UserDtoKafka> userKafkaConsumerFactory(ObjectMapper objectMapper) {
        JsonDeserializer<UserDtoKafka> deserializer =
                new JsonDeserializer<>(UserDtoKafka.class, objectMapper, false);
        deserializer.addTrustedPackages("org.aston.cours.kafka.dto");
